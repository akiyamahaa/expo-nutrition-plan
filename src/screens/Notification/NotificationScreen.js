...
const NotificationScreen = () => {
  ...
  return (
    <View style={HelpScreenStyle.MinViewScreen}>
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={Style.ScrollViewStyle}>
              ...
              <TouchableOpacity style={HelpScreenStyle.FlexDiractionRow}>
                <View>
                  <Image
                    ...
                    resizeMode="cover"
                    source={images.Notification_one}
                  />
                </View>
