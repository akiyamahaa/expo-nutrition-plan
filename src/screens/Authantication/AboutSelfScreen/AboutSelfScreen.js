      ...
      <View style={Authentications.MainViewSingle}>
        <View>
          ...
          <View style={AboutSelfStyles.textcenterview}>
            ...
            <Spacing space={SH(15)} />
            <Text style={[AboutSelfStyles.TextNormal]}>{t('About_Your_Self_2')}</Text>
          </View>
        </View>
        ...
        <View style={AboutSelfStyles.yourSelfRoundMainBox}>
          <TouchableOpacity
            ...
            style={[
              AboutSelfStyles.yourSelfRoundBox,
              activeTab == '0' && AboutSelfStyles.yourSelfRoundActiveBox,
            ]}
          >
            {activeTab == '0' && (
              <Lottie
                source={images.selectionRound}
                Lottiewidthstyle={AboutSelfStyles.selectionRoundBox}
                loop={false}
              />
            )}
            <Image
              resizeMode="contain"
              source={images.male}
              style={AboutSelfStyles.yourSelfRoundImage}
            />
            <Spacing space={SH(10)} />
          ...
          <TouchableOpacity
            ...
            style={[
              AboutSelfStyles.yourSelfRoundBox,
              activeTab == '1' && AboutSelfStyles.yourSelfRoundActiveBox,
            ]}
          >
            {activeTab == '1' && (
              <Lottie
        ...
        <View>
          <View style={Authentications.buttonView}>
            <Button
              ...
              onPress={() => navigation.navigate(RouteName.AGE_SCREEN)}
            />
          </View>
          <Spacing space={SH(25)} />
        </View>
