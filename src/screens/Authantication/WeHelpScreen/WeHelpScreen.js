      ...
      <View style={Authentications.MainViewSingle}>
        <View>
          ...
          <View style={WeHelpStyles.textcenterview}>
            <Text style={[WeHelpStyles.Text, WeHelpStyles.TextBold]}>{t('Welcome_Text')}</Text>
            <Spacing space={SH(15)} />
            <Text style={[WeHelpStyles.TextNormal]}>{t('Choose_Plane')}</Text>
          </View>
        </View>
        <View>
          {dataArray.map((item) => {
            return (
              <>
                <TouchableOpacity
                  onPress={() => onHandleButton(item.id)}
                  style={[
                    WeHelpStyles.MainBox,
                    activeTab == item.id && WeHelpStyles.RoundActiveMainBox,
                  ]}
                >
                  <View style={WeHelpStyles.MainBoxTextView}>
                    <Text
                      style={[
                        WeHelpStyles.buttonBigText,
                        activeTab == item.id && WeHelpStyles.buttonBigTextActive,
                      ]}
                    >
                      {t(item.title)}
                    </Text>
                  ...
                  <Image
                    ...
                    style={WeHelpStyles.rightImageStyle}
                    resizeMode="cover"
                  />
                </TouchableOpacity>
                <Spacing space={SH(30)} />
