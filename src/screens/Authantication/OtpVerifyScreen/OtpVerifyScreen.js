        ...
        <KeyboardAvoidingView enabled>
          <View style={Authentications.MinFlexView}>
            <View style={Authentications.MinViewSecond}>
              <View>
                <Text style={Authentications.verificationTextTitle}>
                  {t('Verification_Text')}
                </Text>
                <Spacing space={SH(15)} />
                <Text style={Authentications.verificationText}>
                  {t('We_Sent_Otp')}
                </Text>
                <Spacing space={SH(3)} />
                <Text style={Authentications.verificationText}>
              ...
              <View style={Authentications.FlexRowText}>
                <Text style={Authentications.ParegraPhotpBottom}>
                  {t('Didnt_Recevip_Otp')}
                </Text>
                <TouchableOpacity onPress={() => setresendModalVisible(true)}>
                  <Text style={Authentications.ResendTextBold}>
                    {t('Resend')}
                  </Text>
                </TouchableOpacity>
              </View>
